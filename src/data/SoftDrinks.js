export const softDrinks = [
  ...
  },
  {
    ...
    cooking: [
      ...
      {
        description:
          "Добавляем туда же&nbsp;клюквенный сок&nbsp;и сахарный сироп. (У меня был&nbsp;клюквенный сок&nbsp;с сахаром, поэтому сироп добавлять я&nbsp;не стала, а&nbsp;просто увеличила количество сока). Доливаем содовой, кладем лед, наливаем в&nbsp;стаканы. ",
        image:
