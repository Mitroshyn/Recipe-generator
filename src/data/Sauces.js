export const sauces = [
  ...
  },
  {
    ...
    cooking: [
      {
        description:
          "В оригинале заправку для&nbsp;салата 'Цезарь' готовят из&nbsp;яиц с&nbsp;оливковым маслом, чесноком и&nbsp;лимоннымсоком, но&nbsp;мы для&nbsp;простоты используем уже&nbsp;готовый майонез. А&nbsp;вот вариантзаправки для&nbsp;салата 'Цезарь' с&nbsp;добавлением авокадо. Авокадо не&nbsp;очень влияет на&nbsp;вкус заправки, но&nbsp;придает приятный салатовый цвет и&nbsp;маслянистую текстуру. ",
      },
      {
        description:
